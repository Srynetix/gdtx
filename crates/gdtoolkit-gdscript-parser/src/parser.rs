...
impl GdScriptParser {
    ...
    pub fn parse_identifier(&self, tokens: &[Token]) -> Result<(GdIdentifier, usize)> {
        match tokens.first() {
    ...
    #[tracing::instrument(skip(self), fields(tokens = %TokenView(tokens)), level = "debug", ret)]
    pub fn parse_type(&self, tokens: &[Token]) -> Result<(GdType, usize)> {
        let mut cursor = 0;
    ...
    #[tracing::instrument(skip(self), fields(tokens = %TokenView(tokens)), level = "debug", ret)]
    pub fn parse_value(&self, tokens: &[Token]) -> Result<(GdValue, usize)> {
        match tokens.first() {
    ...
    #[tracing::instrument(skip(self), fields(tokens = %TokenView(tokens)), level = "debug", ret)]
    pub fn ensure_token<'a>(&self, tok: Token, tokens: &'a [Token]) -> Result<(Token, usize)> {
        match tokens.first() {
    ...
    #[tracing::instrument(skip(self), fields(tokens = %TokenView(tokens)), level = "debug", ret)]
    pub fn ensure_indent<'a>(&self, tokens: &'a [Token]) -> Result<(Token, usize)> {
        match tokens.first() {
    ...
    #[tracing::instrument(skip(self), fields(tokens = %TokenView(tokens)), level = "debug", ret)]
    pub fn ensure_newline<'a>(&self, tokens: &'a [Token]) -> Result<(Token, usize)> {
        match tokens.first() {
    ...
    #[tracing::instrument(skip(self), fields(tokens = %TokenView(tokens)), level = "debug", ret)]
    pub fn ensure_punct<'a>(&self, tokens: &'a [Token]) -> Result<(Token, usize)> {
        match tokens.first() {
    ...
    #[tracing::instrument(skip(self), fields(tokens = %TokenView(tokens)), level = "debug", ret)]
    pub fn parse_decl_extends(&self, tokens: &[Token]) -> Result<(GdDeclExtends, usize)> {
    ...
    #[tracing::instrument(skip(self), fields(tokens = %TokenView(tokens)), level = "debug", ret)]
    pub fn parse_decl_class_name(&self, tokens: &[Token]) -> Result<(GdDecl, usize)> {
        let mut tokens = tokens;
        let mut count = 0;
    ...
    #[tracing::instrument(skip(self), fields(tokens = %TokenView(tokens)), level = "debug", ret)]
    pub fn parse_decl_class(&self, tokens: &[Token]) -> Result<(GdClass, usize)> {
        let mut tokens = tokens;
        let mut count = 0;
    ...
    #[tracing::instrument(skip(self), fields(tokens = %TokenView(tokens)), level = "debug", ret)]
    pub fn parse_decl(&self, tokens: &[Token]) -> Result<(GdDecl, usize)> {
        match tokens.first() {
